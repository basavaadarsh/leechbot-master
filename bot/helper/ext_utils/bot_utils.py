...
def is_share_link(url):
    # Expanded regex to support more domains (gdlink.dev, new gdflix, etc.)
    return bool(re_match(r'https?:\/\/.+\.(gdtot|filepress|filebee|appdrive|gdflix|jiodrive|gdlink|gdlink\.dev|gdflix\.pro|gdflix\.one|gdflix\.xyz|gdflix\.in|gdflix\.cc|gdflix\.me|gdflix\.io|gdflix\.org|gdflix\.net)\.[^\s]+', url))
